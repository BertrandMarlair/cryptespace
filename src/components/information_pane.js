    ...
    return (
      <Paper className="information_pane__paper">
        <Grid container direction="column">
          <Grid item>
            <Typography variant="headline" gutterBottom className="information_pane__title">
              {label}
            </Typography>
            <IconButton onClick={close} aria-label="Close" className="information_pane__close">
              <CloseIcon />
            </IconButton>
          </Grid>
          <Grid item>
